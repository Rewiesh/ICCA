declare
    ...
    is
        ...
        from    Users2 usr
        join    Users_Client2 cnt on cnt.id = usr.id
        left join images2 img on img.imageid = usr.ProfileImage
...
begin
    ...
    loop
        begin
            ...
            -- -- Update oude users2 tabel (idempotent)
            -- update  users2
            ...
            -- -- Update oude users_client2 tabel (idempotent)
            -- update  users_client2
            -- set     cnt_id = ln_cnt_id
            -- where   id = lt_old_data(i).cnt_id;
            
            -- ============================================
            -- STAP 3: emails2 MIGRATIE (met duplicate check EN eml_id update)
            -- ============================================
            ...
            for email_rec in (
                ...
                begin
                    ...
                    -- Update emails2 tabel met eml_id (idempotent)
                    update emails2
    ...
    dbms_output.put_line('========================================');
    dbms_output.put_line('Total users2 processed:    ' || ln_total_users);
    dbms_output.put_line('  - New users2 created:    ' || ln_new_users);
    dbms_output.put_line('  - Existing users2 reused: ' || ln_reused_users);
    dbms_output.put_line('');
    ...
    dbms_output.put_line('');
    dbms_output.put_line('Total emails2:');
    dbms_output.put_line('  - New emails2 created:   ' || ln_new_emails);
    dbms_output.put_line('  - Existing emails2 reused: ' || ln_reused_emails);
    dbms_output.put_line('========================================');
end;
/