create or replace package body icca_pdf_icca_zonder_cijfers_data as
    --
    -- ========================================================================
    -- Package Body: icca_pdf_icca_zonder_cijfers_data
    ...
    begin
        ...
        -- Build JSON object met ICCA_ZONDER_CIJFERS structuur
    ...
    --
    -- 2. Categories - ZONDER CIJFER KOLOM
    --
    ...
    begin
        for r in (
            select cat.name as categorie_naam,
                ...
                -- cijfer weggelaten voor ICCA_ZONDER_CIJFERS
                case
            ...
            -- GEEN cijfer kolom voor ICCA_ZONDER_CIJFERS
    ...
    --
    -- 3. Foutsoorten (met type: dagelijks/cumulatief/divers)
    ...
    --
    -- 4. Max Fouten (hoogste aantal in foutsoorten)
    --
    ...
    --
    -- 5. Verhouding (percentages per fout categorie)
    --
    ...
    --
    -- 6. Ruimte Opmerkingen (fouten per ruimte)
    --
    ...
    --
    -- 7. Element Fotos (logboek fotos met nummer)
    --
    ...
    --
    -- 9. Algemene Opmerkingen (ruimte opmerkingen)
    --
    ...
    --
    -- 10. Overige Hygiene Aspecten (KPI elements)
    --
    ...
    --
    -- Main: Generate Full JSON voor ICCA_ZONDER_CIJFERS
    -- VERSCHIL: geen historisch_verloop sectie
    --
    ...
    begin
        ...
        -- Template naam ICCA_ZONDER_CIJFERS
        l_root.put('template_name', 'ICCA_ZONDER_CIJFERS');
            
        -- Build data object - ZONDER historisch_verloop
        l_data.put('audit_info', f_get_audit_info(p_adt_id));
        l_data.put('categories', f_get_categories(p_adt_id));
        -- GEEN historisch_verloop voor ICCA_ZONDER_CIJFERS
        ...
        dbms_output.put_line('=== JSON DATA ICCA_ZONDER_CIJFERS (BEAUTIFIED) ===');
