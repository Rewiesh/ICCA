create or replace package body icca_pdf_fase_control_data as
    --
    -- Private constants
    --
    ...
    begin
        ...
        l_obj.put('audit_type', 'Kwaliteitsmeting');
    ...
    begin
        ...
        -- Haal laatste 8 audits op voor deze locatie
        for r in (
            select *
            from (
    ...
    begin
        ...
        l_root.put('template_name', 'FASE_CONTROL');
